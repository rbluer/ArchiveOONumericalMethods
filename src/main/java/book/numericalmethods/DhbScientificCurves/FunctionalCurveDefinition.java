...
import book.numericalmethods.DhbInterfaces.CurveMouseClickListener;
 ...
 */
public class FunctionalCurveDefinition implements HistogramOrCurveDefinition
{
	/**
	 * Function to draw.
	 */
	public OneVariableFunction f;
	/**
